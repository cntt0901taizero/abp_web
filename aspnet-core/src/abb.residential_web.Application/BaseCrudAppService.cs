...
{
    public class BaseCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput> : CrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput>
        ...
        where TGetListInput : IPagedResultRequest
    {
        ...
        public BaseCrudAppService(IAppFactory appFactory) : base(appFactory.Repository<TEntity, TKey>())
        {
